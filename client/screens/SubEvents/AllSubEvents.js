        ...
        <ScrollView style={styles.container}>
            ...
            ? (subEvent.map((subEvent) => (
                <View key={subEvent.id} style={styles.item}>
                  <Text style={styles.input}>Event Name: {subEvent.name}</Text>
                  <Text style={styles.input}>Location: {subEvent.location}</Text>
                  <Text style={styles.input}>Time: {new Date(subEvent.startTime).toLocaleTimeString()} - {new Date(subEvent.endTime).toLocaleTimeString()}</Text>
                </View>
              ))) 
            ...
            <TouchableOpacity
                  ...
                  onPress={() =>
                    navigation.navigate('Create Sub Event', { event: event })
                  }
                >
                <Text style={styles.addButtonText}>Create New Sub Event</Text>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
